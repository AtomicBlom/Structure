...
public class OffsetMasterTests
{
	@Test
	public void LStructureAlongZRotatedNorth() {
		...
		Assert.assertTrue(structureTransform.isBlockPresent(0,1, -1));
		Assert.assertTrue(structureTransform.isBlockPresent(0,0, 0));
		Assert.assertFalse(structureTransform.isBlockPresent(0,1, 0));
	}
	...
	public void LStructureAlongZRotatedEast() {
		...
		Assert.assertTrue(structureTransform.isBlockPresent(-1,1, 0));
		Assert.assertTrue(structureTransform.isBlockPresent(0,0, 0));
		Assert.assertFalse(structureTransform.isBlockPresent(0,1, 0));
	}
